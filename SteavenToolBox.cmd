...
if '%choice%'=='7' md "%programdata%\TechSmith\Camtasia Studio 9\" & del "C:\ProgramData\TechSmith\Camtasia Studio 9\RegInfo.ini"  & c:\windows\wget\wget.exe -P "%programdata%\TechSmith\Camtasia Studio 9\" https://github.com/omartube706/SteavenToolBox/raw/main/RegInfo.ini & attrib +R "F:\Software\Editors\Camtasia\8.6.0\Crack\RegInfo.ini"
ECHO "%choice%" is not valid, try again
ECHO.
goto 24
